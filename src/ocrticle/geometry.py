        ...
        return_rects.append(
            {
                "rect": rect,
                "original_x": (
                    points["x1"] - (image.center_x - image.norm_image_size[0] / 2)
                )
                * image.texture_size[0]
                / image.norm_image_size[0],
                "original_y": (
                    points["y1"] - (image.center_y - image.norm_image_size[1] / 2)
                )
                * image.texture_size[1]
                / image.norm_image_size[1],
